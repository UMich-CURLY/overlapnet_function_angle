...
def normalize_data(ground_truth_mapping, normalize_idx=2):
  ...
  # bin_40_49 = bin_40_49[np.random.choice(len(bin_40_49), len(bin_50_59))]
  # bin_50_59 = bin_50_59[np.random.choice(len(bin_50_59), len(bin_90_100))]
